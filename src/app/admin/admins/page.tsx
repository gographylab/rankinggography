...
export default function AdminStaffPage() {
  ...
  // Create a mock list of Admins by picking some users and assigning admin roles
  const adminUsers = [
    { ...allUsers[0], role: 'Superadmin', loc: 'Bangkok, TH' },
    { ...allUsers[1], role: 'Moderator', loc: 'Chiang Mai, TH' },
    { ...allUsers[2], role: 'Editor', loc: 'Phuket, TH' },
  ];
            ...
            <DialogContent className="sm:max-w-[425px] rounded-none">
              ...
              <div className="grid gap-4 py-4 mt-2">
                <div className="grid gap-2">
                  ...
                  <Input id="email" type="email" placeholder="staff@gography.net" className="rounded-none border-neutral-300" />
                </div>
      ...
      <div className="border border-neutral-200 bg-white">
        ...
        <div className="flex flex-col divide-y divide-neutral-100">
          {filteredAdmins.length === 0 ? (
            ...
            <AdminStaffRow key={user.username} user={user} />
          ))}
        </div>
      </div>
    </div>
