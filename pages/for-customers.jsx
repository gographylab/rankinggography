  ...
  return (
    <div className="page-fade">
        ...
        <div className="wrap">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 80, alignItems: 'end' }}>
            <h1 className="display-hero th" style={{ fontSize: 'clamp(56px, 6.6vw, 96px)', margin: 0 }}>
              ภาพจากทริปของคุณ<br />
              <em style={{ fontStyle: 'normal', fontWeight: 500 }}>มีค่ามากกว่าที่คิด</em>
            </h1>
            <p style={{ fontSize: 17, lineHeight: 1.65, color: 'var(--fg-soft)', margin: 0 }} className="th">
              ลูกค้าทุกคนที่เคยร่วมทริป Gography จะได้รับสถานะ <strong style={{ color: 'var(--fg)', fontWeight: 500 }}>Voyageur</strong> — มีสิทธิ์ส่งภาพเข้าประกวดในหมวดพิเศษ <strong style={{ color: 'var(--fg)', fontWeight: 500 }}>Voyageurs Awards</strong> — แข่งกันเฉพาะลูกค้าด้วยกัน เพื่อชิงรางวัลสูงสุด 50,000 บาท ต่อฤดูกาล
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '80px 0', background: 'var(--cream)' }} className="rule-top rule-bot">
        <div className="wrap">
          <SectionHeader eyebrow="The path" title="ขั้นตอนทั้งหมด" />
          <div style={{ display: 'grid', gridTemplateColumns: '180px 1fr', gap: 56, marginTop: 32 }}>
            {[
              ...
              { n: '02', t: 'สร้างบัญชีด้วย Gmail', b: 'ใช้ Gmail เดียวกับที่จองทริป — ทีมงานจะเช็คและ mark สถานะ "Voyageur" ภายใน 7 วัน', cta: { label: 'Login with Gmail', to: '/login' } },
              ...
              <React.Fragment key={s.n}>
                ...
                <div style={{ paddingBottom: 48, borderBottom: '1px solid var(--rule)' }}>
                  ...
                  {s.cta && <button onClick={() => router.go(s.cta.to)} className="btn btn-sm" style={{ marginTop: 20 }}>{s.cta.label}</button>}
                </div>
              </React.Fragment>
            ))}
          </div>
      ...
      <section id="verify" style={{ padding: '96px 0' }}>
        <div className="wrap">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80 }}>
            <div>
              <SectionHeader eyebrow="Already a customer?" title="ยืนยันสถานะ" />
              <p style={{ fontSize: 16, lineHeight: 1.7, color: 'var(--fg-soft)' }} className="th">
                ถ้าคุณเคยร่วมทริปกับเราแล้ว แต่ยังไม่เห็น Voyageur badge บนโปรไฟล์ — ใช้แบบฟอร์มนี้เพื่อให้ทีมงานตรวจสอบ
              </p>
              <div style={{ marginTop: 32, display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <button className="btn btn-solid" style={{ marginTop: 12, justifyContent: 'center' }}>ส่งคำขอยืนยันสถานะ</button>
                <p className="mono" style={{ fontSize: 11, opacity: .55, lineHeight: 1.7, textAlign: 'center', marginTop: 8 }}>
                  ทีมงานจะตอบกลับภายใน 7 วันทำการ
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                {[
                  ...
                  ['Access to Voyageurs section', 'ภาพของคุณจะปรากฏใน Voyageurs section บนหน้า Landing — เพิ่มโอกาสได้รับ exposure'],
        ...
        <div className="wrap">
          ...
          <div style={{ maxWidth: 800 }}>
            {[
              ...
              ['Cashback ใช้ได้กับทริปไหนบ้าง?', 'ทริปใดก็ได้ที่จัดโดย Gography — ระบุก่อนชำระเงิน ทีมงานจะหักส่วนลดให้อัตโนมัติ'],
      ...
      <section style={{ padding: '96px 0' }}>
        <div className="wrap-narrow" style={{ textAlign: 'center' }}>
          <h2 className="th" style={{ fontSize: 48, fontWeight: 400, letterSpacing: '-.025em', margin: 0, lineHeight: 1.15 }}>
            พร้อมส่งภาพแรกของคุณแล้วหรือยัง?
          </h2>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 16, marginTop: 32 }}>
            <button className="btn btn-solid" onClick={() => router.go('/login')}>เริ่มต้น — Login with Gmail</button>
            <Link to="/explore" className="btn">ดูภาพในประกวดก่อน</Link>
          </div>
        </div>
      </section>
...
window.PageForCustomers = PageForCustomers;
