        ...
        <div className="wrap">
          ...
          <div style={{ display: 'flex', gap: 28, borderBottom: '1px solid var(--rule)', paddingBottom: 0 }}>
            {tabs.map(t => {
              ...
              return (
                <button key={t.id || 'all'}
                  onClick={() => router.go(t.id ? `/explore/${t.id}` : '/explore')}
                  style={{
                    padding: '16px 0',
                    fontSize: 13,
                    letterSpacing: '.14em',
...
function EmptyState() {
  return (
    <div style={{ padding: '120px 0', textAlign: 'center' }}>
      <div style={{ fontSize: 48, fontWeight: 300, letterSpacing: '-.02em', marginBottom: 16 }} className="th">ยังไม่มีภาพในหมวดนี้</div>
