  ...
  return (
    <div className="page-fade">
      ...
      <section style={{ padding: '40px 0 80px' }}>
        <div className="wrap">
          {limitReached ? (
            <LimitReachedState countdown={countdown} onView={() => router.go('/photographer/' + (userState === 'customer' ? 'pim.travels' : 'kanthorn'))} />
          ) : (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                  ...
                  {userState !== 'customer' && (
                    <div style={{ padding: '14px 16px', background: 'var(--cream)', border: '1px solid var(--rule)', fontSize: 12, lineHeight: 1.6, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <span>ภาพของคุณจะถูกส่งเข้า <strong>หมวดทั่วไป</strong></span>
                      <Link to="/for-customers" className="caps" style={{ opacity: .6, fontSize: 10, borderBottom: '1px solid var(--rule)', paddingBottom: 2 }}>About Voyageurs →</Link>
                    </div>
                  )}
                  ...
                  <button
                    ...
                    {!draft.file ? 'เลือกภาพก่อน' : !draft.title ? 'ใส่ชื่อภาพ' : 'ส่งภาพเข้าประกวด'}
                  </button>
  ...
  return (
    <div
      ...
      <div>
        ...
        <div style={{ fontSize: 18, fontWeight: 400 }} className="th">ลากวางไฟล์ภาพที่นี่</div>
