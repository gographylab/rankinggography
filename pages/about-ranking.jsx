      ...
      <section style={{ padding: '96px 0 64px' }}>
        <div className="wrap">
          ...
          <h1 className="display-hero th" style={{ fontSize: 'clamp(60px, 7vw, 104px)', margin: 0, maxWidth: '14ch' }}>
            อันดับนี้<br />คำนวณยังไง
          </h1>
          <p style={{ fontSize: 18, color: 'var(--fg-soft)', maxWidth: 560, marginTop: 32, lineHeight: 1.6 }} className="th">
            เราเชื่อว่าผู้ใช้ทุกคนควรเข้าใจว่าทำไมภาพหนึ่งจึงอยู่อันดับสูงกว่าอีกภาพ — สูตรด้านล่างคือ algorithm ทั้งหมดที่เราใช้
          </p>
        </div>
      </section>
...
{`pulse  =  (likes × 1  +  likes_24h × 3  +  curation_bonus)
      ...
      <section style={{ padding: '40px 0 96px' }}>
        <div className="wrap">
          <SectionHeader eyebrow="Worked example" title="ตัวอย่างจริงจาก #1 ปัจจุบัน" />
      ...
      <section style={{ padding: '80px 0', background: 'var(--cream)' }} className="rule-top rule-bot">
        <div className="wrap">
          <SectionHeader title="หลักการ" eyebrow="Why we built it this way" />
      ...
      <section style={{ padding: '96px 0' }}>
        <div className="wrap">
          <SectionHeader title="คำถามที่พบบ่อย" eyebrow="FAQ" />
          <div style={{ maxWidth: 760 }}>
            {[
              ...
              ['Editor\'s Pick เลือกอย่างไร?', 'ทีมงาน Gography คัดเลือกจากภาพที่มี composition และเล่าเรื่องโดดเด่น — ไม่ขึ้นกับจำนวน like'],
...
window.PageAboutRanking = PageAboutRanking;
