  ...
  return (
    <div className="page-fade">
      ...
      <section style={{ position: 'relative' }}>
        <div style={{ height: 380, background: 'var(--tile)', overflow: 'hidden', position: 'relative' }}>
          <img src={photographer.cover} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(180deg, transparent 0%, transparent 50%, rgba(0,0,0,.35) 100%)' }} />
        </div>
      </section>
      ...
      <section>
        <div className="wrap">
          <div style={{ marginTop: -80, display: 'flex', alignItems: 'flex-end', gap: 32, paddingBottom: 40, borderBottom: '1px solid var(--rule)' }}>
            <div style={{ width: 160, height: 160, borderRadius: '50%', overflow: 'hidden', background: 'var(--tile)', border: '4px solid var(--bg)', flexShrink: 0 }}>
              <img src={photographer.avatar} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            </div>
            <div style={{ flex: 1, paddingBottom: 12 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8, flexWrap: 'wrap' }}>
                {photographer.isAmbassador && (
                  <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '4px 10px', background: '#b08e54', color: '#fff', fontSize: 10.5, letterSpacing: '.14em', textTransform: 'uppercase', fontWeight: 500 }}>
                    <CrownIcon /> Ambassador
                  </span>
                )}
                {photographer.isCustomer && <span className="pick solid" style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}><VoyageurMark size={7} />Voyageur</span>}
                <span className="caps" style={{ opacity: .55 }}>@{photographer.username}</span>
              </div>
              <h1 style={{ fontSize: 56, fontWeight: 400, letterSpacing: '-.025em', margin: 0, lineHeight: 1 }}>{photographer.name}</h1>
              <div style={{ display: 'flex', gap: 24, marginTop: 16, alignItems: 'center' }} className="caps">
            ...
            <div style={{ display: 'flex', gap: 12, paddingBottom: 12 }}>
              ...
              <button className="btn btn-solid btn-sm">Follow</button>
            </div>
          </div>
...
window.PagePhotographer = PagePhotographer;
