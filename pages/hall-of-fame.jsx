        ...
        <div className="wrap">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 80, alignItems: 'end' }}>
            ...
            <p style={{ fontSize: 16, lineHeight: 1.7, color: 'var(--fg-soft)', margin: 0 }} className="th">
              ทุก ๆ 4 เดือน Gography คัดเลือกภาพที่ดีที่สุดของฤดูกาลในแต่ละหมวด — ผู้ชนะได้รับ Voucher 50,000 บาท และเข้าสู่ Hall of Fame ตลอดไป
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '48px 0', background: 'var(--cream)' }} className="rule-top rule-bot">
        <div className="wrap">
          ...
          <p className="th" style={{ marginTop: 32, fontSize: 12, color: 'var(--fg-soft)', maxWidth: 720, lineHeight: 1.7 }}>
            รางวัลเฉพาะลูกค้าทริป Gography ที่ได้รับการรับรองโดยทีมงาน — ตรวจสอบสถานะลูกค้าได้ที่หน้าโปรไฟล์ของคุณ
          </p>
        </div>
      </section>
...
window.PageHallOfFame = PageHallOfFame;
