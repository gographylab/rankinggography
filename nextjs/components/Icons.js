...
export function VoyageurMark({ size = 8 }) {
  return (
...
export function CrownIcon({ withStar }) {
  return (
...
export function RewardIcon({ kind = 'voucher', size = 18 }) {
...
export function PickBadge({ kind = 'editor' }) {
  const config = {
